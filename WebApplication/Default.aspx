...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            Synergy .NET business logic within an ASP.NET application, assuming the following:
            </p>
            <ul>
                ...
                <ul>
                    ...
                    <li>xfServer MAY be used as long as your Synergy code uses XCALL S_SERVER_THREAD_INIT.</li>
                </ul>
                </li>
            </ul>
